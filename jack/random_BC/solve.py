...
# TRIAN_STEP = 3*10000
TRIAN_STEP = 6*10000
hlayers_option = [i for i in range(5,8)]
nodes_option = [i for i in range(20,31)]
randNumOption = [i for i in range(100,301)]
bcsample_option = [i for i in range(100,301)]
